...
package dega.api {
	...
	public class VimeoPlayer extends Sprite {
		...
		private var player_width:int = 700;
		private var player_height:int = 500;
		 ...
		 */
		private function playerLoadedCheck(e:TimerEvent = null):void {
		...
		private function mouseMove(e:MouseEvent = null ):void {
			if (e.stageX >= this.x + 544 && e.stageX <= this.x + 544 + this.player_width &&
				e.stageY >= this.y + 150 && e.stageY <= this.y + + 150  + this.player_height) {
